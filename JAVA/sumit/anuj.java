...
public class anuj {
    ...
    public static void printji(int empId, String arr[][]) {
        ...
        String DateofJoining=arr[i][2];

        System.out.println("Emp id   Emp name   Deparment     Designation    Salary       Date of joining");
        System.out.println(empId +"      "+ arr[i][1] +"     "+ arr[i][4] +"          "+ Designation + "         "+salary+"         "+DateofJoining);
