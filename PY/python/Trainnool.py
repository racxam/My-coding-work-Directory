class Train:
    destination=" "
    def BookTicket(self,name,age):
        self.name=name
        self.age=age
        if(age>=18): 
            print("Mr.",name," You can book your ticket ")
        else:
        ...
        print(f"Mr. {name} your Ticket is booked for {destination}!! Congratulations!!\n Your Ticket no. is {(age*13)+12345}")
...
if(ask=="ON"):
    ...
    exit()
nameer=input("Enter your name Mr.\n")
...
if(choice==1):
    name.BookTicket(nameer,age)
elif(choice==2):
    name.GetStatus()
elif(choice==3):
    name.FareInfo()
else:
    print("you can only press 1 2 or 3",nameer,age)
